...
function toggleHeader() {
    ...
    for(let i = 0; i < li.length; i++) {
        li[i].onclick = () => {
            if(i == 0) {
                li[1].classList.remove("bg-blue-600");
                li[0].classList.add("bg-blue-600");
            } else if(i == 1) {
                li[0].classList.remove("bg-blue-600");
                li[1].classList.add("bg-blue-600");
            }
        }
    }
}
    ...
    <header class="absolute left-0 bg-background flex justify-center h-full w-24 shadow-default hover:w-60 ease-in-out duration-300">
        <div class="flex flex-col w-full ease-in-out duration-300">
            <div class="p-4 relative after:content[''] after:absolute after:w-full after:h-px after:bg-afterBackground after:left-0 after:bottom-0">
                <img class="w-full max-w-247" src="/citybens/logotipo-branco-horiz.png" alt="ícone citybens">
            </div>
            <nav class="">
